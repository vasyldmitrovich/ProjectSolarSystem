...
class PlanetPositionTest {
    ...
    void getTrueAnomaly() {
        ...
        double accuracy =100* Math.abs(trueAnomaly - 122.0623) / 122.0623;
        Assertions.assertTrue(accuracy <= 0.001);
    }
    ...
    void getEclipticalCoordinates() {
        ...
        double accuracy =100* Math.abs(eclipticalCoordinates - 13.0664) / 13.0664;
        Assertions.assertTrue(accuracy <= 0.001);
    }
    ...
    void getRightAscension() {
        ...
        double accuracy =100* Math.abs(rightAscension - 11.8605) / 11.8605;
        Assertions.assertTrue(accuracy <= 0.5);
    }

    @Test
    void getDeclination() {
        double declination = planetPositionMars.getDeclination();
        double accuracy = 100*Math.abs(declination - 5.5221) / 5.5221;
        Assertions.assertTrue(accuracy <= 0.5);
    }
    ...
    void getDistanceFromSun() {
        ...
        double accuracy = 100*Math.abs(distanceFromSun - 5.40406) / 5.40406;
        Assertions.assertTrue(accuracy <= 0.5);
    }
    ...
    void getXhelio() {
        ...
        double accuracy = 100*Math.abs(xhelio - (-5.04289)) / 5.04289;
        Assertions.assertTrue(accuracy <= 0.5);
    }
    ...
    void getYhelio() {
        ...
        double accuracy =100* Math.abs(yhelio - 1.93965) / 1.93965;
        Assertions.assertTrue(accuracy <= 0.5);
    }
    ...
    void getZhelio() {
        ...
        double accuracy = 100*Math.abs(zhelio - 0.10478) / 0.10478;
        Assertions.assertTrue(accuracy <= 0.5);
    }
}